...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style = "height: 10vh;">
    <a style = "text-decoration: none; cursor:pointer; width:100px; height:80px;"> <img src = "../../resources/static/images/iconhead.png" alt = "icon.png" style="width:100px; height:80px; object-fit:contain;" class="navbar-brand inline-margin-start" href="update_item.jsp"></a>
