...
<div class="card-group" >
    <div class="card " style = "width: 18rem;" >
        ...
        <div class="card-body">
            ...
            <a href="views/admin/add_item.jsp" class="btn btn-success">ADD ITEM</a>
        </div>
    </div>
    <div class="card " style = "width: 18rem;"><br>
        ...
        <div class="card-body"><br>
            ...
            <a href="views/admin/update_item.jsp" class="btn btn-info">UPDATE ITEM</a>
        </div>
    </div>
    <div class="card " style = "width: 18rem;"><br><br><br>
        ...
        <div class="card-body"><br><br><br>
            ...
            <a href="views/admin/remove_item.jsp" class="btn btn-danger">REMOVE ITEM</a>
        </div>
    </div>
</div>
</body>
