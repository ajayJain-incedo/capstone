...
<nav class="navbar navbar-expand-lg navbar-light blue-bg-color">
    <a href="views/admin/update_item.jsp" style = "text-decoration: none; cursor:pointer; width:6.25rem; height:5rem;" ><img src = "resources/static/images/icon.png" alt = "icon.png" style="width:6.25rem; height:5rem; object-fit:contain;" class="navbar-brand inline-margin-start" ></a>
    ...
    <ul class=" navbar-nav mr-auto inline-list-padding">
        <li class="nav-item d-flex align-items-center text-white mr-16">
            <a href="views/admin/add_item.jsp" class=" white-color nav-link hover-oscillate">Add Item</a>
