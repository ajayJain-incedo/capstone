...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link" href="#">Top Deals </a>
            <a class="nav-item nav-link" href="CategoryProduct?category=Mobiles">Mobiles</a>
            <a class="nav-item nav-link" href="CategoryProduct?category=Electronics">Electronics</a>
            <a class="nav-item nav-link" href="CategoryProduct?category=Appliances">Appliances</a>
